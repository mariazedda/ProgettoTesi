...
for p in range(1, 4):
    ...
    # with open('AverageDivideTesterTrainingFile/' + path + '/P' + str(p) + '/test' + str(s) + '.csv', 'w') as fTest:
        with open('AverageDivideTesterTrainingFile/' + path + '/P' + str(p) + '/test.csv', 'w', newline='') as fTest:
        ...
        with open('AverageDivideTesterTrainingFile/' + path + '/P' + str(p) + '/training.csv', 'w', newline='') as fTraining:
